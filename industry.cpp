...
private:
    string pname, raw;
    double price, n, quantity, c,sum=0;
vector<string>p;
...
cout << "============================================================================================================" << endl;
    ...
    cout<<"                                       Number of production : "<<num<<" pieces "<<q.pname<<endl;
       ...
       cout<<"                                       Production cost : "<<q.sum*num<<" Taka"<<endl;
       cout<<"                                       Total cost : "<<elec*10+q.sum*num<<" Taka"<<endl;
...
cout <<"                                   Showing product no. "<<i+1<<endl<<endl;
  cout << "============================================================================================================" << endl;
        ...
        if(l==1)
        {
            ...
            h+=k*taka;
cout<<"                                   Production cost :"<<e.elec*10+t.sum*e.num<<endl<<endl;
x+=e.elec*10+t.sum*e.num;
cout<<"                                   Profit : "<<k*taka-(e.elec*10+t.sum*e.num)<<endl;
  cout << "============================================================================================================" << endl;
y+=k*taka-(e.elec*10+t.sum*e.num);
